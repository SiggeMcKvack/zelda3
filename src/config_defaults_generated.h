...
const char* kDefaultConfigIni =
    ...
    "# (default: 4:3, accepts: any integer W:H ratio like 16:9, 21:9, 32:9)\n"
    "#\n"
    "# Options (comma-separated):\n"
    "#   - Aspect ratio: Any integer W:H format (e.g., 4:3, 16:9, 16:10, 18:9, 21:9, 32:9)\n"
    ...
    "#\n"
    "# Note: Only integer ratios supported. Decimals like 2.35:1 won't work (use 235:100 instead).\n"
    "# Note: Ratios wider than ~18:9 will render at max width with black bars on sides.\n"
    "#\n"
    "# Examples:\n"
    "#   ExtendedAspectRatio = 16:9\n"
    "#   ExtendedAspectRatio = extend_y, 16:9\n"
    "#   ExtendedAspectRatio = extend_y, 21:9\n"
    "#   ExtendedAspectRatio = extend_y, 32:9\n"
    "ExtendedAspectRatio = extend_y, 16:9\n"
    "\n"
    "# ------------------------------------------------------------------------------\n"
    "# Language Settings\n"
    ...
    "\n"
    "# Minimum sword level to break pots with sword swing\n"
    "# (default: 0, accepts: 0-4)\n"
    "# 0=disabled, 1=wooden, 2=master, 3=tempered, 4=golden\n"
    ...
    "# ------------------------------------------------------------------------------\n"
    "\n"
    "# Load save states (10 slots)\n"
    "# Quick load slot 1 = L2+L3 (default), rest unset\n"
    "Load = L2+L3, , , , , , , , ,\n"
    "\n"
    "# Save states (10 slots)\n"
    "# Quick save slot 1 = L2+R3 (default), rest unset\n"
    "Save = L2+R3, , , , , , , , ,\n"
    "\n"
    "# Replay states (10 slots)\n"
    "Replay = , , , , , , , , ,\n"
    "\n"
    "# Load reference saves (13 slots, advanced feature)\n"
    "LoadRef =\n"
    "\n"
    "# Replay reference saves (13 slots, advanced feature)\n"
    "ReplayRef =\n"
    "\n"
    "# ------------------------------------------------------------------------------\n"
    "# Cheat Keys (Development/Testing)\n"
