// rom_addresses.h - SNES ROM addresses for asset extraction
// These tables contain the locations of compressed/uncompressed graphics data in the ROM
#ifndef RESTOOL_ROM_ADDRESSES_H
#define RESTOOL_ROM_ADDRESSES_H
